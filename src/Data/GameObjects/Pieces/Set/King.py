...
class King(Piece):
    ...
    def moveset(self) -> list[MovesetOption]:
        ...
        movesetOptions.append(MovesetOption(UniversalMoveset.FILE, Direction.UP, 1))
        movesetOptions.append(MovesetOption(UniversalMoveset.FILE, Direction.DOWN, 1))
        movesetOptions.append(MovesetOption(UniversalMoveset.RANK, Direction.LEFT,1))
        movesetOptions.append(MovesetOption(UniversalMoveset.RANK, Direction.RIGHT, 1))
        movesetOptions.append(MovesetOption(UniversalMoveset.MAIN_DIAGONAL, Direction.DOWN, 1))
        ...
        movesetOptions.append(MovesetOption(UniversalMoveset.SECOND_DIAGONAL, Direction.DOWN, 1))
